...
<html lang="en">
  ...
  <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
          <hr>
          <h1 class="display-4"><span class="font-weight-bold">HAPPENED TO BE TRAVERN</span></h1>
          <hr>
        </div>
      </div>
  <!-- Akhir Jumbotron -->
      ...
      <nav class="navbar navbar-expand-lg  bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link mr-4" href="daftar_produk.php">HOME</a>
            </li>
            <li class="nav-item">
              <a class="nav-link mr-4" href="pesanan.php">PESANAN PEMBELI</a>
            </li>
            <li class="nav-item">
              <a class="nav-link mr-4" href="logout_karyawan.php">LOGOUT</a>
            </li>
          </ul>
        </div>
       </div> 
  ...
  <!-- Menu -->
      <div class="container">
        <a href="tambah_produk.php" class="btn btn-success mt-3">TAMBAH DAFTAR PRODUK</a>
        <div class="row">
